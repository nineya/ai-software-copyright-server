...
type StudyApiRouter struct {
	api.BaseApi
}

func (m *StudyApiRouter) InitStudyApiRouter(Router *gin.RouterGroup) {
...
// @security user
// @router /public/study/resource/list [get]
func (m *StudyApiRouter) GetByPage(c *gin.Context) {
