...
type AdminLoginParam struct {
	Username string `json:"username" form:"username" binding:"required,lte=50" label:"用户名"`
	Password string `json:"password" form:"password" binding:"required,gte=8,lte=100" label:"密码"`
